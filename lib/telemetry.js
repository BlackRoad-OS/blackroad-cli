...
class Telemetry {
    constructor() {
        this.metricsDir = path.join(os.homedir(), '.blackroad', 'telemetry');
        this.metricsFile = path.join(this.metricsDir, 'metrics.jsonl');
        this.ensureDir();
    }
...
=======
    showDashboard() {
        ...
        console.log(chalk.gray('Metrics will be collected as you use commands\n'));
>>>>>>> fe685a4 (feat: Add policy, secrets, and workflow commands + new libs)
    }
}
