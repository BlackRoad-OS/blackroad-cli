...
export async function writeDefaultConfig(filePath, force = false) {
...
function mergeConfig(base, override) {
    const mergedAgents = Array.isArray(override.agents) && override.agents.length > 0
        ? override.agents
        : base.agents;
    return {
        ...base,
